...
let limit = 12;
 const {data,hasNextPage,isFetchingNextPage,fetchNextPage}=useInfiniteQuery({
    queryKey: ["products"],
    queryFn: ({pageParam})=>fetch(`https://api.escuelajs.co/api/v1/products?offset=${0}&limit=${limit}`)
    .then((response)=>response.json()),
    initialPageParam: 0,
    getNextPageParam: (_lastPage,allPage)=>{
      const offset  = allPage.length * limit;
              ...
              <div className="flex items-center">
                <div className="w-full flex-wrap px-4 md:w-2/3 lg:w-1/2 -mx-4">
                  <ul className='flex items-center'>
                    <li><a href="" className='inline-block px-3 py-4 text-sm font-medium text-body-color dark:text-dark-6 hover:text-primary dark:hover:text-primary'>About Us</a></li>
                    <li><a href="" className='inline-block px-3 py-4 text-sm font-medium text-body-color dark:text-dark-6 hover:text-primary dark:hover:text-primary'>Order Tracking</a></li>
                    <li><a href="" className='inline-block px-3 py-4 text-sm font-medium text-body-color dark:text-dark-6 hover:text-primary dark:hover:text-primary'>Contact Us</a></li>
                    <li><a href="" className='inline-block px-3 py-4 text-sm font-medium text-body-color dark:text-dark-6 hover:text-primary dark:hover:text-primary'>FAQs</a></li>
                  </ul>
                </div>
                  ...
                  <div className="items-center justify-end flex">
                    <div>
                      <div className='relative'>
                        <select className="w-full py-3 pl-3 pr-5 text-sm font-medium transition bg-transparent rounded-lg outline-none appearance-none text-body-color dark:text-dark-6">
                            <option value="" className='dark:bg-dark-2'>English</option>
                            <option value="" className='dark:bg-dark-2'>Bangla</option>
                            <option value="" className='dark:bg-dark-2'>Japanese</option>
                        </select>
                      ...
                      <div>
                        <div className="relative">
                          <select className="w-full py-3 pl-3 pr-5 text-sm font-medium transition bg-transparent rounded-lg outline-none appearance-none text-body-color dark:text-dark-6">
                            <option value="" className="dark:bg-dark-2">USD</option>
                            <option value="" className="dark:bg-dark-2">INR</option>
                            <option value="" className="dark:bg-dark-2">ERU</option>
                          </select>
                          <span className="absolute right-0 -translate-y-1/2 top-1/2 text-body-color dark:text-dark-6">
                            <svg
                              width="14"
                      ...
                      <div className='relative z-20'>
                        ...
                        <div className={twMerge("absolute top-full right-0 mt-5 w-[330px]",account?"":"hidden")}>
                          <div className="px-6 py-8 overflow-hidden bg-white border rounded-lg border-stroke dark:border-dark-3 dark:bg-dark-2 shadow-1 dark:shadow-box-dark">
                            ...
                            <div>
                              <button className="flex w-full items-center justify-center rounded-md bg-primary-600 py-[10px] px-10 text-center text-base font-medium text-white hover:bg-primary-900">
                                Add to Cart
                              </button>
                            </div>
                          </div>
      ...
      <main className="flex relative">
        <div className='h-screen w-full flex justify-center'>
          ...
          <div className='w-full max-w-5xl px-6'>
            ...
            <div className="flex justify-center gap-2 py-5 w-full" ref={ref}>
                 {isFetchingNextPage && <p>Loading...</p>}
                 {!isFetchingNextPage && !hasNextPage && <p>No more product</p>}
            </div>
          </div>
        </div>
      </main>
...
export default infinityDataFetching;
